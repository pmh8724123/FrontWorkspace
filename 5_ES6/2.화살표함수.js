...
const declareFn2 = (a,b) => a*b; // 중괄호,return 묶음 생략가능 두 줄 이상 {} 필요
const declaerFn3 = a => a; // 매개변수가 1개라면 소괄호도 생략가능
...
const obj3 = {
    ...
    arrowFn : function(){
        ...
        console.log(getName2()); // 3? global의 this.name
    }
};
obj3.arrowFn();
...
/* 
    1) call(thisargs, ...args)
     - 함수의 this를 첫번재 인자로 전달된 값으로 변경한 후 호출
*/ 
...
printName.apply({name:'pmh'}, ['hello', 'Mr. Park']);
