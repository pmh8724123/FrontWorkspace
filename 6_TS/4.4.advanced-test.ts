...
// address는 주소이며 클래스 내에서만 접근가능하며, 
// 객체 생성시에만 대입이 가능하고 수정이 불가능한 속성입니다.

// introduction은 함수이며 어디서든 접근 가능합니다.

// introduction은 클래스의 name,address,age속성에 저장된 내용을 출력하며 매개변수와 반환값은 
// 없는 메서드입니다.
...
//  function print<T extends { length: number }>(item?: T): void {
//      const value: T = (item == null ? { length: 0 } as T : item);
//      console.log(value.length);
//  }
// print("hello"); // 5
// print([1, 2, 3]); // 3
...
type ProductUpdateInput = Required<Pick<Product, "id" | "name" | "price">> & Partial<Pick<Product,"description" | "stock">>;
...
// {id:3,name:'galaxy3',price:1500000,category:'핸드폰'};
